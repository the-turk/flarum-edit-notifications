...
/* harmony import */ var _modals_EditNotificationsSettingsModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modals/EditNotificationsSettingsModal */ "./src/admin/modals/EditNotificationsSettingsModal.js");

 // initialize settings modal

flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('the-turk-edit-notifications', function (app) {
  app.extensionSettings['the-turk-edit-notifications'] = function () {
    return app.modal.show(new _modals_EditNotificationsSettingsModal__WEBPACK_IMPORTED_MODULE_1__["default"]());
  };
});

/***/ }),

/***/ "./src/admin/modals/EditNotificationsSettingsModal.js":
/*!************************************************************!*\
  !*** ./src/admin/modals/EditNotificationsSettingsModal.js ***!
  \************************************************************/
/*! exports provided: default */
...
var settingsPrefix = 'the-turk-edit-notifications.';
var translationPrefix = settingsPrefix + 'admin.settings.';
...
function (_SettingsModal) {
  ...
  _proto.form = function form() {
    ...
    return [m('.Form-group', [m('label', flarum_components_Switch__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans(translationPrefix + 'enableInteracts'),
      onchange: function onchange(value) {
        _this.setting(settingsPrefix + 'enableInteracts')(value ? '1' : '0');
      }
    }))])];
  };
